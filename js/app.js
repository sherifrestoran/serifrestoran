...
(function () {
  ...
  function enablePullToRefresh() {
    ...
    document.addEventListener("touchstart", (e) => {
      ...
      // Eğer dokunuş menü scroll alanındaysa ve scrollTop>0 ise kullanıcı menüyü kaydırıyordur.
      const scroller = e.target && e.target.closest ? e.target.closest(".menu-scroll") : null;
    ...
    document.addEventListener("touchmove", (e) => {
      ...
      // Eğer dokunuş menü scroll alanındaysa ve scrollTop>0 ise tetikleme.
      const scroller = e.target && e.target.closest ? e.target.closest(".menu-scroll") : null;
      if (scroller && scroller.scrollTop > 0) return;

      triggered = true;
      // Küçük bir gecikme, kullanıcı hareketini tamamlasın
